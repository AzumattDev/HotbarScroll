...
## Pretty simple, client side mod that allows you to hold a modifier key (or keys) to scroll through your hotbar.
...
3. **Download the latest release of HotbarScroll from Thunderstore.io.**
...
2. **Open the Mod Manager and search for "HotbarScroll" under the Online
